...
export default function StaffLoginPage() {
  ...
  return (
    <div className="green-theme staff-login-wrap">
      {/* Logo — fixed header on mobile, inline on desktop */}
      <div className="staff-login-logo">
        <span style={{ fontSize: 22, fontWeight: 700, color: "var(--g-primary)" }}>MarkG</span>
        <span style={{ fontSize: 22, fontWeight: 300, color: "#fff" }}>CRM</span>
      </div>

      {/* Card */}
      <div className="staff-login-card">
        {/* Hero area — visible on mobile only */}
              ...
              <label style={{ display: "flex", alignItems: "center", gap: 8, color: "#757575", cursor: "pointer" }}>
                <div
                  ...
                  style={{
                    ...
                    background: remember ? "var(--g-primary)" : "#ccc",
                    cursor: "pointer", position: "relative", transition: "background .2s", flexShrink: 0,
                  }}
                >
                  <div style={{
                    position: "absolute",
                    left: remember ? 18 : 2, top: 2,
      ...
      <Link
        href="/"
        style={{ marginTop: 24, color: "rgba(255,255,255,0.4)", fontSize: 12, textDecoration: "none" }}
